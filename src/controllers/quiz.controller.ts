...
export async function updateQuiz(req: Request<unknown, unknown, Quiz>, res: Response<Quiz | string>) {
    return (await editQuiz({...req.body, createdBy: (<User>req.user).login!}))
