...
export async function submitQuizAttempt(req: Request<unknown, unknown, QuizSubmission>, res: Response<QuizSubmissionResult | string>) {
    return (await createQuizAttempt(req.body))
